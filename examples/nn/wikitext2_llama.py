...
SLOPE_BACKEND=iree python examples/nn/wikitext2_gpt.py
SLOPE_BACKEND=onnxruntime python examples/nn/wikitext2_gpt.py

# print backend code
LOG_JIT=1 SLOPE_BACKEND=iree python examples/nn/wikitext2_gpt.py
"""
